...
<body class="overflow-hidden-x">
  ...
  <main class="main min-vh-100" id="top">
    ...
    <section class="py-0" id="page-contact">
      <div class="container-fluid">
        <div class="row">
          <!-- CONTATO -->
          <div class="col-lg-6 bg-white pt-8 pb-4">
              ...
              <div class="col-lg-8" data-zanim-lg='{"animation":"slide-left","delay":0.6}' data-zanim-trigger="scroll">
                ...
                <p class="fw-bold mb-0">
                  ...
                  <span class="ms-2 fw-normal">
                    Av. Presidente Kennedy, 735 sala 323<br />Estrela do Norte, São Gonçalo 24445-795, RJ
                  </span>
                </p>
                <p class="fw-bold mb-0">
                  Phone:<span class="ms-2 fw-normal">
                    <a class="text-700" href="https://api.whatsapp.com/send?phone=5521985084862" target="_blank">
                      (21) 98508-4862
                    </a>
                  </span>
                </p>
                <p class="fw-bold mb-4">
                  E-mail:<span class="ms-2 fw-normal fst-italic">
                    <a class="text-700" href="mailto:projetos@athosarquitetura.net" target="_blank">
                      projetos@athosarquitetura.net
                    </a>
                  </span>
                </p>
                <div class="mt-3">
                  <a class="btn btn-dark btn-sm me-2" href="#!">
                    <span class="fab fa-twitter" data-fa-transform="grow-6"></span>
                  </a>
                  <a class="btn btn-dark btn-sm me-2" href="#!">
                    <span class="fab fa-facebook-f" data-fa-transform="grow-6"></span>
                  </a>
                  <a class="btn btn-dark btn-sm me-2" href="https://instagram.com/athosarquitetura">
                    <span class="fab fa-instagram" data-fa-transform="grow-6"></span>
                  </a>
                  <a class="btn btn-dark btn-sm" href="https://br.pinterest.com/ArquiteturaAthos">
                ...
                <form class="mt-4" action="send-email.php" name="sender" method="POST">
                  ...
                  <div class="d-grid">
                    <button class="btn btn-block btn-dark mt-4" type="submit">
                      Enviar<span class="fa fa-paper-plane ms-1"></span>
                    </button>
                  </div>
                </form>
              </div>
          ...
          <div class="col-lg-6 px-0">
            <div class="sticky-top ovrflow-hidden-y">
              <div class="googlemap min-vh-100 d-none d-lg-block" data-gmap="data-gmap"
                data-latlng="-22.8207404,-43.0395819,3a,75y,346.04h,87.35t" data-pov='{"heading":0,"pitch":-15}'
                data-scrollwheel="false" data-icon="assets/images/map-marker.png" data-zoom="1" data-theme="streetview"
                data-zanim-lg='{"animation":"zoom-out-slide-left","delay":0.4}' data-zanim-trigger="scroll"></div>

              <!--Mobile Fallback-->
              <div class="googlemap min-vh-50 d-lg-none" data-gmap="data-gmap"
                data-latlng="-22.8207404,-43.0395819,3a,75y,346.04h,87.35t" data-pov='{"heading":0,"pitch":-15}'
                data-scrollwheel="false" data-icon="../assets/img/map-marker.png" data-zoom="17" data-theme="Default">
                <div class="marker-content py-3">
                  <h5>Athos Arquitetura</h5>
                  <p>
                    O empreendimento Icon Business &amp; Mall é referência <br> em Centro de Negócios no Município de
                    São Gonçalo.
                  </p>
                </div>
              </div>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCAZ1YjNbWcVAprk03nIOeIVydwK6y0YPc&callback=initMap"
    async></script>
